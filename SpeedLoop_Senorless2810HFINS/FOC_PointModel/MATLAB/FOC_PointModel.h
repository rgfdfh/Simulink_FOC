...
#define CURR_OVER                      25.0F                     /* Referenced by: '<S14>/Constant50' *//* 过流保护值，应注意不能大于IMAX。单位：A */
...
#define CURR_UNDER                     0.03F                     /* Referenced by: '<S14>/Constant58' *//* 欠流值，为了处理出现堵住但观测器发散、实际电机电流很小的情况。单位：A
                                                                      */
#define CURR_WIDTH                     4096.0F                   /* Referenced by:
                                                                  * '<S14>/Constant11'
                                                                  * '<S14>/Constant9'
...
#define PLL_WIDTH                      1638.0F                   /* Referenced by:
                                                                  * '<S14>/Constant25'
                                                                  * '<S14>/Constant26'
                                                                  *//* 锁相环带宽 */
...
#define SPD_LPF_LEVEL                  15                        /* Referenced by: '<S35>/Constant1' *//* PLL速度滤波器等级，范围0~15，越高滤波性越强 */
#define SPD_MAX                        13600                     /* Referenced by: '<S18>/Constant6' *//* 最大转速，这个为实际使用时使用标准电压正常工作所会达到的最大值，用于降压时限制最大转速。单位：RPM */
...
#define UDC_GAIN                       21.0F                     /* Referenced by: '<S14>/ADC量程*母线电压分压倍数//定义的最大电压值' *//* 母线电压分压倍数，单位：无 */
...
typedef struct {
  ...
  int32_T UnitDelay_DSTATE;            /* '<S44>/Unit Delay' */
  int32_T UnitDelay_DSTATE_f;          /* '<S47>/Unit Delay' */
  int32_T UnitDelay_DSTATE_h;          /* '<S55>/Unit Delay' */
  int32_T UnitDelay3_DSTATE_m;         /* '<S19>/Unit Delay3' */
  int32_T UnitDelay_DSTATE_g;          /* '<S64>/Unit Delay' */
  int32_T Delay_DSTATE;                /* '<S54>/Delay' */
  int32_T UnitDelay_DSTATE_b;          /* '<S52>/Unit Delay' */
  int32_T UnitDelay_DSTATE_d;          /* '<S51>/Unit Delay' */
  ...
  int16_T UnitDelay5_DSTATE;           /* '<S42>/Unit Delay5' */
 ...
 * Block '<S26>/Saturation1' : Unused code path elimination
 ...
 * Block '<S10>/Shift Arithmetic7' : Unused code path elimination
 ...
 * Block '<S64>/Constant1' : Unused code path elimination
 ...
 * Block '<S42>/Shift Arithmetic7' : Eliminated trivial shift
 */
 ...
 * '<S7>'   : 'Senorless/FOC_PointModel/OutSPD'
 ...
 * '<S35>'  : 'Senorless/FOC_PointModel/OutSPD/LPF'
 * '<S36>'  : 'Senorless/FOC_PointModel/SVPWM/AntiClark'
 * '<S37>'  : 'Senorless/FOC_PointModel/SVPWM/ei_t'
 * '<S38>'  : 'Senorless/FOC_PointModel/idq_Controller/PI Controller'
 * '<S39>'  : 'Senorless/FOC_PointModel/idq_Controller/PI Controller1'
 * '<S40>'  : 'Senorless/FOC_PointModel/idq_Controller/Saturation Dynamic1'
 * '<S41>'  : 'Senorless/FOC_PointModel/idq_Controller/Saturation Dynamic2'
 * '<S42>'  : 'Senorless/FOC_PointModel/idq_Controller/Subsystem'
 * '<S43>'  : 'Senorless/FOC_PointModel/idq_Controller/PI Controller/Saturation Dynamic2'
 * '<S44>'  : 'Senorless/FOC_PointModel/idq_Controller/PI Controller/积分器'
 * '<S45>'  : 'Senorless/FOC_PointModel/idq_Controller/PI Controller/积分器/Saturation Dynamic2'
 * '<S46>'  : 'Senorless/FOC_PointModel/idq_Controller/PI Controller1/Saturation Dynamic2'
 * '<S47>'  : 'Senorless/FOC_PointModel/idq_Controller/PI Controller1/积分器'
 * '<S48>'  : 'Senorless/FOC_PointModel/idq_Controller/PI Controller1/积分器/Saturation Dynamic2'
 * '<S49>'  : 'Senorless/FOC_PointModel/idq_Controller/Subsystem/Wrap To Zero1'
 * '<S50>'  : 'Senorless/FOC_PointModel/加速强拖/加速积分角度'
 * '<S51>'  : 'Senorless/FOC_PointModel/加速强拖/加速积分角度/积分器3'
 * '<S52>'  : 'Senorless/FOC_PointModel/加速强拖/加速积分角度/积分器4'
 * '<S53>'  : 'Senorless/FOC_PointModel/恒速降力矩强拖/Saturation Dynamic2'
 * '<S54>'  : 'Senorless/FOC_PointModel/恒速降力矩强拖/积分器'
 * '<S55>'  : 'Senorless/FOC_PointModel/慢速开环/积分器'
 * '<S56>'  : 'Senorless/FOC_PointModel/电压限转速/Saturation Dynamic2'
 * '<S57>'  : 'Senorless/FOC_PointModel/观测器闭环//速度环/PI Controller'
 * '<S58>'  : 'Senorless/FOC_PointModel/观测器闭环//速度环/Saturation Dynamic2'
 * '<S59>'  : 'Senorless/FOC_PointModel/观测器闭环//速度环/Wrap To Zero'
 * '<S60>'  : 'Senorless/FOC_PointModel/观测器闭环//速度环/Wrap To Zero1'
 * '<S61>'  : 'Senorless/FOC_PointModel/观测器闭环//速度环/Wrap To Zero2'
 * '<S62>'  : 'Senorless/FOC_PointModel/观测器闭环//速度环/速度缓冲'
 * '<S63>'  : 'Senorless/FOC_PointModel/观测器闭环//速度环/PI Controller/Saturation Dynamic2'
 * '<S64>'  : 'Senorless/FOC_PointModel/观测器闭环//速度环/PI Controller/积分器1'
 * '<S65>'  : 'Senorless/FOC_PointModel/观测器闭环//速度环/PI Controller/积分器1/Saturation Dynamic2'
 */
