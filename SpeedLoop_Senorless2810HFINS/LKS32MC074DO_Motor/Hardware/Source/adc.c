...
void HAL_ADC0_Init(void)
{
    ...
    ADC_CHN_GAIN_CFG(ADC0, CHN0, ADC_CHANNEL_0, ADC_GAIN3V6); // CH3是OPA0, W相A，用PWM1组
...
void HAL_ADC1_Init()
{
    ...
    ADC_CHN_GAIN_CFG(ADC1, CHN0, ADC_CHANNEL_8, ADC_GAIN3V6); // CH12是母线电压值，采样次数中多次采样顺序对应CHNx、DATx
