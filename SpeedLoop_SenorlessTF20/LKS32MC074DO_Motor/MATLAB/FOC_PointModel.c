...
void FOC_PointModel_step(void)
{
   ...
   *  Product: '<S1>/Product1'
   */
  rtb_Sum1_o = (rtU.ib * rtDW.Curr_Conversion) >> ((int16_T)CURR_POINT_GAIN);
  ...
  if (rtb_ShiftArithmetic_f < 0) {
    rtb_ShiftArithmetic3 = -rtb_ShiftArithmetic_f;
  } else {
    rtb_ShiftArithmetic3 = rtb_ShiftArithmetic_f;
  }
  ...
  /* MinMax: '<S5>/Max' */
  if (rtb_ShiftArithmetic3 >= rtb_Gain_av) {
    rtb_Gain_av = rtb_ShiftArithmetic3;
  }

  /* Abs: '<S5>/Abs3' */
  if (rtb_Min1 < 0) {
    rtb_ShiftArithmetic3 = -rtb_Min1;
  } else {
    rtb_ShiftArithmetic3 = rtb_Min1;
  }
  ...
  /* MinMax: '<S5>/Max' */
  if (rtb_Gain_av >= rtb_ShiftArithmetic3) {
    rtb_ShiftArithmetic3 = rtb_Gain_av;
  }
   ...
   */
  rtb_ShiftArithmetic9_f = (rtDW.UnitDelay9_DSTATE_j * 15 + rtb_ShiftArithmetic3)
    >> 4;
   ...
   */
  rtb_Bias_a = (int16_T)((int16_T)(((int16_T)Udc) - 3) - (int16_T)((((int16_T)
  ...
  switch (rtAction) {
   ...
   case 2:
    ...
    rtb_ShiftArithmetic9_f = (((rtb_ShiftArithmetic3 >> ((int16_T)TS_POINT_GAIN))
      * rtDW.Ts_Point) >> 15) + rtDW.UnitDelay_DSTATE_e;
    ...
    rtDW.UnitDelay_DSTATE_e = rtb_ShiftArithmetic9_f;
   ...
   *  Sum: '<S10>/Sum2'
   */
  rtb_Bias_a = rtConstP.pooled15[plook_u32u16_even0ckag((uint16_T)((uint32_T)
   ...
   *  Sum: '<S4>/Add2'
   */
  rtb_Sum1_o = ((rtb_Sum1_o - rtb_Min1) * ((int16_T)DIVSQRT3)) >> 15;
   ...
   *  Sum: '<S12>/Sum4'
   */
  rtb_Sum_ix = rtConstP.pooled15[plook_u32u16_even0ckag((uint16_T)((uint32_T)
    rtDW.Merge >> 7), 1U)];
  ...
  if (rtb_RelationalOperator) {
     ...
     *  Sum: '<S7>/Add2'
     */
    rtb_Gain_av = rtb_Sum5_f - ((rtb_ShiftArithmetic_f * rtb_Bias_a + rtb_Sum1_o
      * rtb_Sum_ix) >> 15);
    if (rtb_Gain_av > 32767) {
      rtb_Gain_av = 32767;
    } else if (rtb_Gain_av < -32768) {
      rtb_Gain_av = -32768;
    }
     ...
     */
    rtb_ShiftArithmetic9_f = rtDW.Curr_Ki_Point >> ((int16_T)TS_POINT_GAIN);
     ...
     */
    rtb_Min1 = ((rtDW.Ts_Point * (int16_T)rtb_Gain_av) >> 15) *
      rtb_ShiftArithmetic9_f + rtDW.UnitDelay_DSTATE;
    ...
    if (rtb_Min1 > rtDW.Curr_Limit) {
      rtb_Min1 = rtDW.Curr_Limit;
    } else if (rtb_Min1 < -rtDW.Curr_Limit) {
     ...
     *  Sum: '<S9>/Sum1'
     */
    rtb_ShiftArithmetic3 = (int16_T)rtb_Gain_av * rtDW.Curr_Kp_Point + rtb_Min1;
     ...
     */
    rtb_Saturation_n = (int16_T)(rtDW.Merge1 - rtDW.UnitDelay3_DSTATE_d);
     ...
     *  Switch: '<S39>/Switch'
     */
    if (rtb_Saturation_n > ((int16_T)CURR_STEP)) {
      rtb_Saturation_n = ((int16_T)CURR_STEP);
    } else if (rtb_Saturation_n < (int16_T)-((int16_T)CURR_STEP)) {
      /* Switch: '<S39>/Switch' incorporates:
       *  Constant: '<S9>/Constant3'
       */
      rtb_Saturation_n = (int16_T)-((int16_T)CURR_STEP);
    }
     ...
     *  UnitDelay: '<S9>/Unit Delay3'
     */
    rtb_Saturation_n += rtDW.UnitDelay3_DSTATE_d;
     ...
     *  Sum: '<S7>/Add1'
     */
    rtb_Gain_av = rtb_Saturation_n - ((rtb_Sum1_o * rtb_Bias_a -
     ...
     */
    rtb_ShiftArithmetic3 = ((rtDW.Ts_Point * (int16_T)rtb_Gain_av) >> 15) *
      rtb_ShiftArithmetic9_f + rtDW.UnitDelay_DSTATE_f;
     ...
     */
    if (rtb_ShiftArithmetic3 > rtDW.Curr_Limit) {
      rtb_ShiftArithmetic9_f = rtDW.Curr_Limit;
    } else {
      /* Gain: '<S45>/Gain' */
      rtb_ShiftArithmetic9_f = -rtDW.Curr_Limit;
     ...
     *  Sum: '<S9>/Sum8'
     */
    rtb_ShiftArithmetic3 = (int16_T)rtb_Gain_av * rtDW.Curr_Kp_Point
    ...
    rtDW.UnitDelay_DSTATE = rtb_Min1;

    /* Update for UnitDelay: '<S9>/Unit Delay3' */
    rtDW.UnitDelay3_DSTATE_d = rtb_Saturation_n;

    /* Update for UnitDelay: '<S45>/Unit Delay' */
    rtDW.UnitDelay_DSTATE_f = rtb_ShiftArithmetic9_f;
  } else {
   ...
   *  Sum: '<S2>/Add'
   */
  rtb_ShiftArithmetic9_f = (rtDW.Ud * rtb_Bias_a - rtDW.Uq * rtb_Sum_ix) >> 15;
   ...
   *  Sum: '<S2>/Add1'
   */
  rtb_Min1 = (rtDW.Ud * rtb_Sum_ix + rtDW.Uq * rtb_Bias_a) >> 15;
  ...
  if (rtb_RelationalOperator) {
     ...
     */
    rtb_Gain_av = (((rtDW.Obs_VtoI * rtb_ShiftArithmetic9_f -
     ...
     *  Sum: '<S25>/Sum5'
     */
    rtb_ShiftArithmetic3 = (rtb_Gain_av - rtb_ShiftArithmetic_f) * rtDW.SMO_K;
     ...
     */
    rtb_ShiftArithmetic_f = (((rtb_ShiftArithmetic3 - rtDW.UnitDelay1_DSTATE) *
      rtDW.LPF_FRQ_Point) >> 15) + rtDW.UnitDelay1_DSTATE;

    /* Update for UnitDelay: '<S25>/Unit Delay4' incorporates:
     *  Sum: '<S25>/Sum9'
     */
    rtDW.UnitDelay4_DSTATE = rtb_ShiftArithmetic3 + rtb_ShiftArithmetic_f;
     ...
     */
    rtb_Sum7 = (((rtDW.Obs_VtoI * rtb_Min1 - rtDW.UnitDelay2_DSTATE) *
                 rtDW.SMO_Gain2) >> 15) + ((rtDW.UnitDelay3_DSTATE_l *
      rtDW.SMO_Gain1) >> 15);
     ...
     *  Sum: '<S25>/Sum8'
     */
    rtb_ShiftArithmetic3 = (rtb_Sum7 - rtb_Sum1_o) * rtDW.SMO_K;
     ...
     */
    rtb_ShiftArithmetic3 = -((rtConstP.pooled15[plook_u32u16_even0ckag((uint16_T)
      ((uint32_T)(uint16_T)(rtY.Obs_Theta + 16384U) >> 7), 1U)] *
      rtb_ShiftArithmetic_f) >> 15) - ((rtConstP.pooled15[plook_u32u16_even0ckag
      ((uint16_T)((uint32_T)rtY.Obs_Theta >> 7), 1U)] * rtb_Sum1_o) >> 15);
     ...
     */
    rtb_ShiftArithmetic_f = ((rtDW.Ts_Point * rtb_ShiftArithmetic3) >> 15) *
     ...
     *  Switch: '<S32>/Switch'
     */
    if (rtb_ShiftArithmetic_f > rtDW.PLL_Limit) {
      rtb_ShiftArithmetic_f = rtDW.PLL_Limit;
    } else if (rtb_ShiftArithmetic_f < -rtDW.PLL_Limit) {
     ...
     */
    rtb_Sum1_o = rtb_ShiftArithmetic3 * rtDW.PLL_Kp + rtb_ShiftArithmetic_f;

    /* Switch: '<S30>/Switch2' incorporates:
     *  DataStoreRead: '<S27>/Data Store Read3'
     *  RelationalOperator: '<S30>/LowerRelop1'
     */
    if (rtb_Sum1_o > rtDW.PLL_Limit) {
       ...
       */
      if (rtb_Sum1_o >= -rtDW.PLL_Limit) {
        rtb_ShiftArithmetic3 = rtb_Sum1_o;
      }
     ...
     */
    rtb_Sum1_o = (((rtb_ShiftArithmetic3 >> 15) * rtDW.Ts_Point) >> ((int16_T)
      TS_POINT_GAIN)) + rtDW.UnitDelay_DSTATE_m;
    ...
    if (((int16_T)SPD_LPF_LEVEL) > 15) {
      ...
      rtb_Saturation_n = ((int16_T)SPD_LPF_LEVEL);
    }
     ...
     */
    rtY.Obs_Spd = ((16 - rtb_Saturation_n) * (rtb_ShiftArithmetic3 >> 16) +
                   rtY.Obs_Spd * rtb_Saturation_n) >> 4;
    ...
    rtY.Obs_Theta = (uint16_T)((uint32_T)
      ...
      * rtDW.UnitDelay1_DSTATE_p) >> 15, 1)] + (uint16_T)rtb_Sum1_o);

    /* Update for UnitDelay: '<S31>/Unit Delay' */
    rtDW.UnitDelay_DSTATE_p = rtb_ShiftArithmetic_f;

    /* Update for UnitDelay: '<S29>/Unit Delay' */
    rtDW.UnitDelay_DSTATE_m = rtb_Sum1_o;
   ...
   *  Gain: '<S35>/Gain1'
   */
  rtb_ShiftArithmetic3 = (28377 * rtb_Min1) >> 15;

  /* ArithShift: '<S35>/Shift Arithmetic1' incorporates:
   *  ArithShift: '<S2>/Shift Arithmetic'
   */
  rtb_Min1 = rtb_ShiftArithmetic9_f >> 1;

  /* Sum: '<S35>/Sum' */
  rtb_ShiftArithmetic_f = rtb_ShiftArithmetic3 - rtb_Min1;

  /* Sum: '<S35>/Sum1' */
  rtb_Sum1_o = -rtb_ShiftArithmetic3 - rtb_Min1;
  ...
  /* MinMax: '<S36>/Min' */
  if (rtb_ShiftArithmetic9_f <= rtb_ShiftArithmetic_f) {
    rtb_ShiftArithmetic3 = rtb_ShiftArithmetic9_f;
  } else {
    rtb_ShiftArithmetic3 = rtb_ShiftArithmetic_f;
  }
  ...
  /* MinMax: '<S36>/Min1' */
  if (rtb_ShiftArithmetic9_f >= rtb_ShiftArithmetic_f) {
    rtb_Gain_av = rtb_ShiftArithmetic9_f;
  } else {
    rtb_Gain_av = rtb_ShiftArithmetic_f;
  }

  /* MinMax: '<S36>/Min' */
  if (rtb_ShiftArithmetic3 > rtb_Sum1_o) {
    rtb_ShiftArithmetic3 = rtb_Sum1_o;
  }

  /* MinMax: '<S36>/Min1' */
  if (rtb_Gain_av < rtb_Sum1_o) {
    rtb_Gain_av = rtb_Sum1_o;
  }
   ...
   *  Sum: '<S36>/Sum'
   */
  rtb_ShiftArithmetic3 = -((rtb_ShiftArithmetic3 + rtb_Gain_av) >> 1);
   ...
   */
  rtb_Min1 = rtb_ShiftArithmetic9_f + rtb_ShiftArithmetic3;

  /* Saturate: '<S8>/Saturation' */
  if (rtb_Min1 > 16384) {
    rtb_Min1 = 16384;
  } else if (rtb_Min1 < -16383) {
    rtb_Min1 = -16383;
  }
   ...
   *  Sum: '<S8>/Sum1'
   */
  rtY.tABC[0] = (uint16_T)(rtb_Bias_a - ((rtb_Min1 * rtDW.PWM_TH) >> 15));

  /* Sum: '<S8>/Sum' incorporates:
   *  SignalConversion generated from: '<S8>/Sum'
   */
  rtb_Min1 = rtb_ShiftArithmetic_f + rtb_ShiftArithmetic3;
   ...
   *  Sum: '<S8>/Sum1'
   */
  rtY.tABC[1] = (uint16_T)(rtb_Bias_a - ((rtb_Min1 * rtDW.PWM_TH) >> 15));

  /* Sum: '<S8>/Sum' incorporates:
   *  SignalConversion generated from: '<S8>/Sum'
   */
  rtb_Min1 = rtb_Sum1_o + rtb_ShiftArithmetic3;
   ...
   *  Sum: '<S8>/Sum1'
   */
  rtY.tABC[2] = (uint16_T)(rtb_Bias_a - ((rtb_Min1 * rtDW.PWM_TH) >> 15));
