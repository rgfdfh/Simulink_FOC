...
#if defined ( __CC_ARM ) || defined (__GNUC__) // Keil/GCC
#include "lks32mc07x.h"
#include "basic.h"
#elif defined ( __ICCARM__ )    // IAR
#include <linko/iolks32mc07x.h>
#endif
